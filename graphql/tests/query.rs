...
#[test]
fn can_query_an_interface() {
    const QUERY: &str = "
    query {
        reviews(first: 100, orderBy: id) {
            body
        }
    }";
...
#[test]
fn can_query_an_interface_with_child_filter_of_entity() {
    const QUERY: &str = "
    query {
...
#[test]
fn can_query_an_object_with_child_filter_of_interface() {
    const QUERY: &str = "
    query {
